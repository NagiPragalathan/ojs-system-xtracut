...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.1',
  'unifunc' => 'content_6721c93a40cdb2_83020508',
...
function content_6721c93a40cdb2_83020508 (Smarty_Internal_Template $_smarty_tpl) {
...
if (!is_null($_smarty_tpl->tpl_vars['row']->value->getId())) {?>
	...
	<?php if (strlen((string) $_smarty_tpl->tpl_vars['categoryId']->value) > 0) {?>
...
if ($_smarty_tpl->tpl_vars['row']->value->getActions(\PKP\controllers\grid\GridHandler::GRID_ACTION_POSITION_DEFAULT)) {?>
...
"<?php }?>>
			<?php if ($_smarty_tpl->tpl_vars['row']->value->hasActions() && $_smarty_tpl->tpl_vars['column']->value->hasFlag('firstColumn')) {?>
				<?php if ($_smarty_tpl->tpl_vars['row']->value->getActions(\PKP\controllers\grid\GridHandler::GRID_ACTION_POSITION_DEFAULT)) {?>
				...
				<div class="row_actions">
					<?php if ($_smarty_tpl->tpl_vars['row']->value->getActions(\PKP\controllers\grid\GridRow::GRID_ACTION_POSITION_ROW_LEFT)) {?>
						<?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['row']->value->getActions(\PKP\controllers\grid\GridRow::GRID_ACTION_POSITION_ROW_LEFT), 'action');
...
">
			<?php if ($_smarty_tpl->tpl_vars['row']->value->getActions(\PKP\controllers\grid\GridHandler::GRID_ACTION_POSITION_DEFAULT)) {?>
				<?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['row']->value->getActions(\PKP\controllers\grid\GridHandler::GRID_ACTION_POSITION_DEFAULT), 'action');
$_smarty_tpl->tpl_vars['action']->do_else = true;
if ($_from !== null) foreach ($_from as $_smarty_tpl->tpl_vars['action']->value) {
$_smarty_tpl->tpl_vars['action']->do_else = false;
?>
